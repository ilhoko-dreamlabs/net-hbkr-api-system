...
const endpoints={"layers":{"method":"GET","path":"/v0/taxonomy/layers","response":{"taxonomyVersion":"0.1-draft","items":[{"id":"L3","name":"AI Engineering 운영·품질·보안","definition":"Model intelligence를 business capability로 변환하는 engineering layer","examples":["LLMOps","AgentOps","Evaluation","Observability","Security"]},{"id":"L4","name":"AI 에이전트 개발","definition":"목표를 받아 tool과 memory를 사용해 수행하는 system layer","examples":["Planning","사용 기술-use","Memory","Orchestration"]}],"notice":"Draft taxonomy. Not a proficiency scale."}},"roles":{"method":"GET","path":"/v0/roles?layer=L3","response":{"items":[{"id":"agentops-engineer","name":"AgentOps Engineer","layerIds":["L3"],"capabilityIds":["agent-evaluation","agent-observability","guardrail-operations"]},{"id":"agentops-product-engineer","name":"AgentOps Product Engineer","layerIds":["L3","L5"],"capabilityIds":["agent-runtime","evaluation-platform","product-delivery"]}],"relation":"AI 업무 영역 ↔ 역할 is many-to-many."}},"talent":{"method":"GET","path":"/v0/talents/tal_sample_001","response":{"id":"tal_sample_001","memberId":"mem_sample_001","primaryRole":{"id":"agent-architect","layerIds":["L2","L3","L4"]},"capabilityClaims":[{"capabilityId":"permission-aware-rag","deliveryLevel":"customer-production","responsibilityScope":"technical-lead","evidenceIds":["ev_sample_101"]}],"availability":{"status":"available-now","engagementTypes":["project","consulting"]},"boundaries":["owner-required","data-access-required"],"sample":true}},"project":{"method":"GET","path":"/v0/projects/prj_sample_001","response":{"id":"prj_sample_001","problem":"권한에 맞는 사내 지식 검색과 근거 답변","requiredLayers":["L2","L3","L4"],"roleRequirements":[{"roleId":"agent-architect","priority":"required"}],"capabilityRequirements":[{"capabilityId":"permission-aware-rag","minimum개발·수행Level":"customer-production","priority":"required"}],"assets":["documents","sso-api","internal-pm"],"verificationRequired":["sso-api-spec","privacy-policy"],"sample":true}},"match":{"method":"POST","path":"/v0/match-assessments","response":{"id":"ma_sample_001","projectId":"prj_sample_001","talentId":"tal_sample_001","referenceScore":82,"fitRationale":["필요한 AI 업무 영역 L2/L3/L4가 겹침","Permission-aware RAG evidence linked","투입 가능 시점이 프로젝트 조건과 맞음"],"capabilityGaps":["Customer SSO implementation evidence not exposed"],"verificationRequired":["Review evidence ev_sample_101","보안 책임 범위 확인"],"recommendedNextStep":"30분 실무 확인 미팅","limitations":["예시 업무 분류의 일치 여부만 반영","본인 확인, 비용, 계약 조건과 수행 근거의 진위는 확인하지 않음"]}}};let activeEndpoint="layers";
